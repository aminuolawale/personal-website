...
export default async function AllProjectsPage() {
  ...
  return (
    <main className="pt-24 sm:pt-32 pb-16 sm:pb-24 px-6 sm:px-16 max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        <p className="font-mono text-accent text-xs mb-2">Software Engineering</p>
        <h1 className="text-surface text-3xl sm:text-4xl font-bold">All Projects</h1>
      </div>

      {allProjects.length === 0 ? (
        <p className="font-mono text-sm text-muted/40">No projects published yet.</p>
      ) : (
          ...
          {allProjects.map((p) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="text-surface font-semibold text-base mb-3 group-hover:text-accent transition-colors">
                  {p.title}
                </h2>
