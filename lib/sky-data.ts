...
export const BG_STARS: [number, number, number][] = [
  ...
  // Hercules figure support stars. The named catalog only includes Beta Her
  // (Kornephoros), so these keep the highlighted standard outline complete.
  [245.48,19.15,3.75],[250.32,31.60,2.81],[250.72,38.92,3.53],[255.07,30.93,3.92],
  [258.76,24.84,3.14],[258.76,36.81,3.16],[260.92,37.15,4.15],[262.68,26.11,4.41],
  [264.87,46.01,3.80],[266.62,27.72,3.42],[269.06,37.25,3.86],[269.63,30.19,4.41],
];
...
export const CONSTELLATIONS: Constellation[] = [
  ...
  },
  {
    name: "Hercules",
    lines: [
      // Standard Hercules stick figure, centered on the Keystone:
      // Zeta → Eta → Pi → Epsilon → Zeta.
      [[250.32,31.60],[250.72,38.92],[258.76,36.81],[255.07,30.93],[250.32,31.60]],
      // Southern body and legs through Beta/Kornephoros and Alpha/Rasalgethi.
      [[250.32,31.60],[247.56,21.49],[245.48,19.15]],
      [[255.07,30.93],[258.76,24.84],[258.66,14.39]],
      [[247.56,21.49],[258.76,24.84]],
      // Northern arms/upper extensions.
      [[250.72,38.92],[264.87,46.01]],
      [[258.76,36.81],[260.92,37.15],[269.06,37.25]],
      // Eastern leg extension.
      [[258.76,24.84],[266.62,27.72],[269.63,30.19]],
      [[266.62,27.72],[262.68,26.11]],
    ],
  },
  {
    name: "Cygnus",
